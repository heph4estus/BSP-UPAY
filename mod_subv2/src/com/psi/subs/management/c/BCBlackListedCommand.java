...
import com.psi.subs.management.m.BCBlackListedCollection;
...
public class BCBlackListedCommand extends UICommand{
	...
	public IView execute() {
		...
		try {
			...
			if(sess.exists()) {	
				BCBlackListedCollection model = new BCBlackListedCollection();
	...
	public String getKey() {
		return "BCBLACKLISTEDCOLLECTION";
	}
