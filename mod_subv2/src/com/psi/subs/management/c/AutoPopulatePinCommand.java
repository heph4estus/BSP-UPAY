...
import com.psi.subs.management.m.AutoPopulatePinCollection;
...
public class AutoPopulatePinCommand extends UICommand{
	...
	public IView execute() {
		...
		try {
			...
			if(sess.exists()) {	
				AutoPopulatePinCollection model = new AutoPopulatePinCollection();
				model.setBcid(this.params.get("BCID"));
