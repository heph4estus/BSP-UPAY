...
public class PreApproveMerchCommand extends UICommand{
		...
		try {
			...
			if(sess.exists()) {
				...
				reg.mechantdetails();
						...
						if(reg.preapprove()){
							reg.setState(new ObjectState("00", "Successfully pre-approved merchant account"));
							AuditTrail audit  = new AuditTrail();
				    		audit.setIp(reg.getAuthorizedSession().getIpAddress());
				    		audit.setModuleid(String.valueOf(this.getId()));
				    		audit.setEntityid(accountnumber);
