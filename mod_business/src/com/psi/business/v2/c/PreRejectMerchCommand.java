...
public class PreRejectMerchCommand extends UICommand{
...
//						    audit.setData(reg.getBusinessname());
						...
						if(reg.forescalition()){
							reg.setState(new ObjectState("00", "Successfully for escalation merchant account"));
							AuditTrail audit  = new AuditTrail();
				    		audit.setIp(reg.getAuthorizedSession().getIpAddress());
				    		audit.setModuleid(String.valueOf(this.getId()));
				    		audit.setEntityid(accountnumber);
