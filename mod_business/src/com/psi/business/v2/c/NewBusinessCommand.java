...
import com.psi.business.v2.m.NewBusiness;
			    ...
			    reg.setAuthorizedSession(sess);
					try {
						...
						if(reg.existemailpndg()){
							reg.setState(new ObjectState("12", "Email Address already exist in pending merchants"));
							AuditTrail audit  = new AuditTrail();
				    		audit.setIp(reg.getAuthorizedSession().getIpAddress());
				    		audit.setModuleid(String.valueOf(this.getId()));
				    		audit.setEntityid(businessname+"|"+msisdn);
						...
						if(reg.register(accountnumber)){
							reg.setState(new ObjectState("00", "Successfully request merchant registration"));
							AuditTrail audit  = new AuditTrail();
				    		audit.setIp(reg.getAuthorizedSession().getIpAddress());
				    		audit.setModuleid(String.valueOf(this.getId()));
				    		audit.setEntityid(businessname+"|"+msisdn);
