...
import com.psi.business.v2.m.MercServicesStatCollection;
...
public class MercServicesStatColCommand extends UICommand{
	...
	public IView execute() {
		...
		try {
			...
			if(sess.exists()) {
				MercServicesStatCollection col = new MercServicesStatCollection();
