...
import com.psi.tariff.config.m.TariffPlansGroupCollection;
...
public class TariffPlansGroupColCommand extends UICommand{
	...
	public IView execute() {
		...
		try {
			...
			if(sess.exists()) {
				...
				TariffPlansGroupCollection model = new TariffPlansGroupCollection(groupname);
					model.setType(type);
	...
	public String getKey() {
		return "GROUPTARIFFPLANSCOLLECTION";
	}
