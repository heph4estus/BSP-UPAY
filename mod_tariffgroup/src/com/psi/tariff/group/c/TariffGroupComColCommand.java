...
import com.psi.tariff.group.m.TariffGroupCollection;
...
public class TariffGroupComColCommand extends UICommand{
	...
	public IView execute() {
		...
		try {
			...
			if(sess.exists()) {
				...
				TariffGroupCollection model = new TariffGroupCollection();
	
					model.setAuthorizedSession(sess);
					
						if(model.hasRowscommission()){
	...
	public String getKey() {
		return "TARIFFGROUPCOMMISSIONCOL";
	}
