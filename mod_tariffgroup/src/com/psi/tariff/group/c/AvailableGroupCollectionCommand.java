...
import com.psi.tariff.group.m.AvailableGroupCollection;
...
public class AvailableGroupCollectionCommand extends UICommand{
	...
	public IView execute() {
		...
		try {
			...
			if(sess.exists()) {
				...
				AvailableGroupCollection model = new AvailableGroupCollection();
