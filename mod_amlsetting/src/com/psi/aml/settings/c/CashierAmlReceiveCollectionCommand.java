...
import com.psi.aml.settings.m.CashierAmlReceiveCollection;
import com.psi.aml.settings.v.CollectionView;
import com.psi.aml.settings.v.NoDataFoundView;
...
public class CashierAmlReceiveCollectionCommand extends UICommand{
	...
	public IView execute() {
		...
		try {
			...
			if(sess.exists()) {
				...
				CashierAmlReceiveCollection col = new CashierAmlReceiveCollection();
	...
	public String getKey() {
		return "CASHIERAMLRECEIVECOLLECTION";
	}
