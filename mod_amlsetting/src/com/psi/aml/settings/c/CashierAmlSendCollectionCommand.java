...
import com.psi.aml.settings.m.CashierAmlSendCollection;
...
public class CashierAmlSendCollectionCommand extends UICommand{
	...
	public IView execute() {
		...
		try {
			...
			if(sess.exists()) {
				...
				CashierAmlSendCollection col = new CashierAmlSendCollection();
	...
	public String getKey() {
		return "CASHIERAMLSENDCOLLECTION";
	}
