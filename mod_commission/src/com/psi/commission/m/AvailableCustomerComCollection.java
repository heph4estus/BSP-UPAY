...
public class AvailableCustomerComCollection extends ModelCollection{
	...
	public boolean hasRows() {
		...
		if(!this.category.equals("ALL")){rr = SystemInfo.getDb().QueryDataRow("SELECT * FROM TBLBRANCHPRODUCTS WHERE TYPE='REVENUECUS' AND CATEGORY IS NULL AND SERVICE = ?",this.service);}
		else{rr = SystemInfo.getDb().QueryDataRow("SELECT * FROM TBLBRANCHPRODUCTS WHERE TYPE='REVENUECUS' AND CATEGORY = 'ALL' AND SERVICE = ?",this.service);}
