...
public class AvailComTariffCollection extends ModelCollection{
	...
	public boolean hasRows() {
		DataRow rr = SystemInfo.getDb().QueryDataRow("SELECT * FROM TBLPROVIDERPRODUCTS WHERE TYPE='TARIFF' AND CATEGORY = ? AND SERVICE = ?",this.category,this.service);
