...
public class ApproveCustomeUpgradeCommand extends UICommand{
		...
		try {
			...
			if(sess.exists()) {
				...
				reg.setAuthorizedSession(sess);
						...
						//}
						if(reg.approve()){
							reg.setState(new ObjectState("00", "Successfully upgraded customer account"));
							AuditTrail audit  = new AuditTrail();
				    		audit.setIp(reg.getAuthorizedSession().getIpAddress());
				    		audit.setModuleid(String.valueOf(this.getId()));
				    		audit.setEntityid(accountnumber);
							...
							reg.setState(new ObjectState("01", "Failed! Unable to upgrade customer account"));
							AuditTrail audit  = new AuditTrail();
				    		audit.setIp(reg.getAuthorizedSession().getIpAddress());
				    		audit.setModuleid(String.valueOf(this.getId()));
				    		audit.setEntityid(accountnumber);
