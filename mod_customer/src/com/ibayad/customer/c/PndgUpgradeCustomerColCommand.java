...
public class PndgUpgradeCustomerColCommand extends UICommand{
	...
	public IView execute() {
		...
		try {
			...
			if(sess.exists()) {
				...
				if(col.hasRowsPndgUpgrade()){
					AuditTrail audit  = new AuditTrail();
		    		audit.setIp(col.getAuthorizedSession().getIpAddress());
		    		audit.setModuleid(String.valueOf(this.getId()));
		    		audit.setEntityid("");
		    		audit.setLog("Successfully fetched pending upgrade customer data");
		    		audit.setStatus("00");
					...
					return new CollectionView("00",col);  
						...
						ObjectState state = new ObjectState("01", "No pending upgrade customer data found");
						AuditTrail audit  = new AuditTrail();
			    		audit.setIp(col.getAuthorizedSession().getIpAddress());
			    		audit.setModuleid(String.valueOf(this.getId()));
			    		audit.setEntityid("");
	...
	public String getKey() {
		return "PNDGUPGRADECUSTOMERCOLLECTION";
	}
