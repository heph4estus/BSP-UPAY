...
public class VoidedTransCollection extends ModelCollection{
	protected String datefrom;
	protected String dateto;
	protected String accountnumber;
	@Override
	public boolean hasRows() {
		DataRowCollection r = SystemInfo.getDb().QueryDataRows("SELECT * FROM TBLVOIDEDTRANSACTIONS WHERE TO_CHAR(DATECOMPLETED,'YYYY-MM-DD') BETWEEN ? AND ? AND ACCOUNTNUMBER = ?",this.datefrom,this.dateto,this.accountnumber);
