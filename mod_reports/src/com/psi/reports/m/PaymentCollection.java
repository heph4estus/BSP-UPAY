...
public class PaymentCollection extends ModelCollection{
	...
	public boolean getEPColBranches() {
		DataRowCollection r = SystemInfo.getDb().QueryDataRows("SELECT * FROM TBLTRANSACTIONABSPAYMENT WHERE TOACCOUNT=? AND  TO_CHAR(TIMESTAMP,'YYYY-MM-DD') BETWEEN ? AND ?",this.branch,this.datefrom,this.dateto);
