...
public class AllocationCollection extends ModelCollection{
	...
	public boolean hasRows() {
		DataRowCollection r = SystemInfo.getDb().QueryDataRows("SELECT * FROM TBLALLOCTRANSACTIONS WHERE TOACCOUNT IN (SELECT ACCOUNTNUMBER FROM TBLBRANCHES) AND TO_CHAR(TIMESTAMP,'YYYY-MM-DD') BETWEEN ? AND ?",this.datefrom,this.dateto);
	...
	public boolean hasRowsAllCom() {
		DataRowCollection r = SystemInfo.getDb().QueryDataRows("SELECT * FROM TBLALLOCTRANSACTIONS WHERE TOACCOUNT IN (SELECT ACCOUNTNUMBER FROM TBLBUSINESS) AND TO_CHAR(TIMESTAMP,'YYYY-MM-DD') BETWEEN ? AND ?",this.datefrom,this.dateto);
