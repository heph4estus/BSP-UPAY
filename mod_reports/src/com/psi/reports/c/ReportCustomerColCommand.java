...
import com.psi.reports.m.ReportCustomerCollection;
...
public class ReportCustomerColCommand extends UICommand{

	@Override
	public IView execute() {
		String accountnumber = this.params.get("AccountNumber").toString();
		ReportCustomerCollection model = new ReportCustomerCollection();
	...
	public String getKey() {
		return "REPORTCUSTOMERCOLLECTION";
	}
