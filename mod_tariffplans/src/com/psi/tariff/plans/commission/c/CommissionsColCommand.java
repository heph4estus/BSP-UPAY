...
import com.psi.tariff.plans.commission.m.CommissionsCollection;
...
public class CommissionsColCommand extends UICommand{
	...
	public IView execute() {
		...
		try {
			...
			if(sess.exists()) {
				CommissionsCollection model = new CommissionsCollection();
