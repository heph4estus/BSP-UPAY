...
import com.psi.tariff.plans.commission.m.TariffGroupComCollection;
...
public class TariffGroupComColCommand extends UICommand{
	...
	public IView execute() {
		...
		try {
			...
			if(sess.exists()) {
				...
				TariffGroupComCollection model = new TariffGroupComCollection();
				...
				model.setType(type);
					model.setAuthorizedSession(sess);
						...
						if(model.hasRows()){
				    		...
				    		audit.setLog("Successfully fetched tariff group commission data");
				    		audit.setStatus("00");
