...
import com.psi.tariff.plans.m.SendAmlCollection;
...
public class SendAmlCollectionCommand extends UICommand{
	...
	public IView execute() {
		...
		try {
			...
			if(sess.exists()) {
				SendAmlCollection model = new SendAmlCollection();
