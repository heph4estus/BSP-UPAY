...
import com.psi.tariff.plans.m.NewServiceFee;
...
public class NewServiceFeeCommand extends UICommand{
	...
	public IView execute() {
		...
		try {
			...
			if(sess.exists()) {
				...
				Long percentage = LongUtil.toLong(this.params.get("Percentage").toString());
				Long fixed = LongUtil.toLong(this.params.get("Fixed").toString());
				String type = this.params.get("Type").toString();
				
				NewServiceFee create = new NewServiceFee();
