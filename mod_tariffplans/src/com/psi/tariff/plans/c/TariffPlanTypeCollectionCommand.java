...
import com.psi.tariff.plans.m.TariffPlanTypeCollection;
...
public class TariffPlanTypeCollectionCommand extends UICommand{
	...
	public IView execute() {
		...
		try {
			...
			if(sess.exists()) {
				...
				TariffPlanTypeCollection model = new TariffPlanTypeCollection();
				model.setType(type);
	...
	public String getKey() {
		return "TARIFFPLANTYPECOLLECTION";
	}
