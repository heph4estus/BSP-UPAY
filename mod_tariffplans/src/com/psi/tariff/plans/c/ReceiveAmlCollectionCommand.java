...
import com.psi.tariff.plans.m.ReceiveAmlCollection;
...
public class ReceiveAmlCollectionCommand extends UICommand{
	...
	public IView execute() {
		...
		try {
			...
			if(sess.exists()) {
				ReceiveAmlCollection model = new ReceiveAmlCollection();
