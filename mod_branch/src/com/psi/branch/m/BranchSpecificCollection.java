...
public class BranchSpecificCollection extends ModelCollection{
	...
	public boolean hasRows() {
		DataRowCollection r = SystemInfo.getDb().QueryDataRows("SELECT * FROM TBLBRANCHES WHERE ACCOUNTNUMBER = ?",this.accountnumber);
	...
	public boolean hasRowsPndg() {
		DataRowCollection r = SystemInfo.getDb().QueryDataRows("SELECT * FROM TBLMERCHANTPNDG WHERE ACCOUNTNUMBER = ?",this.accountnumber);
