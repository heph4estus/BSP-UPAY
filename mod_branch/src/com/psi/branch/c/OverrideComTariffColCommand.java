...
import com.psi.branch.m.OverrideComTariffCollection;
...
public class OverrideComTariffColCommand extends UICommand{
	...
	public IView execute() {
		...
		try {
			...
			if(sess.exists()) {
				...
				OverrideComTariffCollection model = new OverrideComTariffCollection();
	...
	public String getKey() {
		return "TARIFFGROUPOVERCOMCOLLECTION";
	}
