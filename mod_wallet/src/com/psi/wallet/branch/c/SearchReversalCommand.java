...
import com.psi.wallet.branch.m.SearchReversal;
...
public class SearchReversalCommand extends UICommand{
	...
	public IView execute() {
		...
		try {
			...
			if(sess.exists()) {
				...
				SearchReversal topup = new SearchReversal();
