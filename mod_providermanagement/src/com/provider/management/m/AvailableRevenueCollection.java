...
public class AvailableRevenueCollection extends ModelCollection{
	protected String service;
	protected String category;
	protected String provider;
	@Override
	public boolean hasRows() {
		DataRow rr = SystemInfo.getDb().QueryDataRow("SELECT * FROM TBLPROVIDERPRODUCTS WHERE TYPE='REVENUE' AND PROVIDER = ? AND CATEGORY = ? AND SERVICE = ?",this.provider,this.category,this.service);
