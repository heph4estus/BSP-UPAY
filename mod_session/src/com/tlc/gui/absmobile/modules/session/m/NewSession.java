...
//			query.append("	ELSE\n");
			...
			query.append("	INSERT INTO TBLAUDITTRAIL(USERNAME,USERID,SESSIONID,MODULE,IP,STATUS,BROWSER,BROWSERVERSION,PORTALVERSION,OS,USERSLEVEL,LOG,DATA) VALUES(vUSERNAME,vEXISTS,vSESSIONID,vMODULEID,vIPADDRESS,vSTATUSCODE,vBROWSER,vBROWSERVERSION,vPORTALVERSION,vOS,vGROUPNAME,'Success','Logged in to the System');\n");
			//query.append("	END IF;\n");
		query.append("	END IF;\n");
