...
public class LockUnlockAcctCommand extends UICommand{
			...
			if(sess.exists()) {
				...
				reg.setAuthorizedSession(sess);
					...
					if(accounttype.equals("BRANCH")){
						if(reg.lockunlockbranch()){
							reg.setState(new ObjectState("00", "Successfully change branch account locked"));
							AuditTrail audit  = new AuditTrail();
				    		audit.setIp(reg.getAuthorizedSession().getIpAddress());
				    		audit.setModuleid(String.valueOf(this.getId()));
				    		audit.setEntityid(accountnumber);
						...
						if(reg.lockunlockcompany()){
							reg.setState(new ObjectState("00", "Successfully change merchant account locked"));
							AuditTrail audit  = new AuditTrail();
				    		audit.setIp(reg.getAuthorizedSession().getIpAddress());
				    		audit.setModuleid(String.valueOf(this.getId()));
				    		audit.setEntityid(accountnumber);
						...
						if(reg.lockunlockcustomer()){
							reg.setState(new ObjectState("00", "Successfully change customer account locked"));
							AuditTrail audit  = new AuditTrail();
				    		audit.setIp(reg.getAuthorizedSession().getIpAddress());
				    		audit.setModuleid(String.valueOf(this.getId()));
				    		audit.setEntityid(accountnumber);
