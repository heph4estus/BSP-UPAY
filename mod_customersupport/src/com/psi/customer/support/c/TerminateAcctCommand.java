...
public class TerminateAcctCommand extends UICommand{
			...
			if(sess.exists()) {
				...
				reg.setAuthorizedSession(sess);
					...
					if(accounttype.equals("BRANCH")){
						if(reg.terminatebranch()){
							reg.setState(new ObjectState("00", "Successfully terminated branch account"));
							AuditTrail audit  = new AuditTrail();
				    		audit.setIp(reg.getAuthorizedSession().getIpAddress());
				    		audit.setModuleid(String.valueOf(this.getId()));
				    		audit.setEntityid(accountnumber);
						...
						if(reg.terminatecompany()){
							reg.setState(new ObjectState("00", "Successfully terminated merchant account"));
							AuditTrail audit  = new AuditTrail();
				    		audit.setIp(reg.getAuthorizedSession().getIpAddress());
				    		audit.setModuleid(String.valueOf(this.getId()));
				    		audit.setEntityid(accountnumber);
						...
						if(reg.terminatecustomer()){
							reg.setState(new ObjectState("00", "Successfully terminated customer account"));
							AuditTrail audit  = new AuditTrail();
				    		audit.setIp(reg.getAuthorizedSession().getIpAddress());
				    		audit.setModuleid(String.valueOf(this.getId()));
				    		audit.setEntityid(accountnumber);
